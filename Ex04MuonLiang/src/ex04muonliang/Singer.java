...
public class Singer {
    ...
    public void performForAudience(Singer name1, Singer name2) {
        name1.earnings = 1200/2;
        name2.earnings = 1200/2;
        noOfPerformances++;
        
        System.out.printf("%s performed with %s. %nThe former earned %.2f and the latter also earned %.2f. The total number of performances of the singers is now %d. %n%n", name1.Name, name2.Name, name1.earnings, name2.earnings, noOfPerformances);
    }
